...
// Temporary root-test wiring. Task 6 replaces these with direct leaf-test imports.
#[cfg(test)]
...
#[cfg(test)]
use runtime::{advance_cascade, load_armed, prime_backlog, Cascade, ENTER_MS, STEP_MS};
#[cfg(test)]
mod tests {
    use super::*;
